...
<div className="flex w-full h-screen">
  <div className="w-full flex items-center justify-center lg:w-1/2">
    <div className="w-11/12 max-w-[700px] px-10 py-20 rounded-3xl bg-white border-2 border-gray-100">
      <h1 className="text-5xl font-semibold tracking-wide text-gray-800">Register!</h1>
      <p className="font-medium text-lg text-gray-500 mt-4 tracking-widest">Please enter your details.</p>
      <div className="mt-8">
        ...
        <div className="mt-8 flex justify-center items-center tracking-wider">
          ...
          <button
            ...
            className="ml-2 font-medium text-base text-violet-500 focus:outline-none hover:text-violet-600"
          >
            Login
          </button>
        </div>
